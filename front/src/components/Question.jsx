...
function Question() {
	...
	const handleSubmit = async (e) => {
		...
		/* yeni formatta örnek post isteği:
			const activities = [ 
				{name: "A", content: "asfhsa", links: ["1", "2"]},
				{name: "B", content: "zzz", links: ["4", "5"]},
			]
			formData.append('appName', "MyNewApp");
			formData.append('activities', activities);
			formData.append('generalExplaining', "bla bla bla");
			formData.append('appIcon', data.appIcon);
